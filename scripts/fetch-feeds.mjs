...
const GROUPS = {
  ...
  "TOMORROW X TOGETHER": ["tomorrow x together", "tomorrow_x_together", "투모로우바이투게더", "txt", "トゥバ", "トゥモローバイトゥゲザー"],
  ...
  "少女時代": ["girls' generation", "girls’ generation", "girls generation", "소녀시대", "少女時代", "snsd"],
  ...
  "ALPHA DRIVE ONE": ["alpha drive one", "ald1", "알파드라이브원", "アルファドライブワン"],
  "CORTIS": ["cortis", "코르티스", "コルティス"],
  "Hearts2Hearts": ["hearts2hearts", "hearts 2 hearts", "하츠투하츠", "ハーツトゥハーツ"],
  "ALLDAY PROJECT": ["allday project", "올데이 프로젝트", "オールデイプロジェクト"],
  "KiiiKiii": ["kiiikiii", "키키", "キキ"],
  "tripleS": ["triples", "트리플에스", "トリプルエス"],
  "RESCENE": ["rescene", "리센느", "リセンヌ"],
  "izna": ["izna", "이즈나", "イズナ"],
  "MEOVV": ["meovv", "미야오", "ミャオ"],
  ...
  "VIVIZ": ["viviz", "비비지", "ビビジ"],
  "QWER": ["qwer", "큐더블유이알"],
  "WayV": ["wayv", "威神v", "웨이션브이", "ウェイシェンブイ"],
  "&TEAM": ["&team", "エンティーム", "엔팀"],
  "NEXZ": ["nexz", "넥스지", "ネクスジ"],
  "2PM": ["2pm", "투피엠", "トゥーピーエム"],
  "EVNNE": ["evnne", "이븐", "イブネ"],
  "xikers": ["xikers", "싸이커스", "サイカス"],
  "n.SSign": ["n.ssign", "엔싸인", "エンサイン"],
  "UNIS": ["unis", "유니스", "ユニス"],
  "OH MY GIRL": ["oh my girl", "오마이걸", "オーマイガール"],
  "IZ*ONE": ["iz*one", "iz-one", "izone", "아이즈원", "アイズワン"],
  "MADEIN": ["madein", "메이딘", "メイディン"],
  "BADVILLAIN": ["badvillain", "배드빌런"],
  "NouerA": ["nouera", "누에라"],
  "AHOF": ["ahof", "에이코프"],
  "IDID": ["idid", "이디드"],
  "GOT7": ["got7", "갓세븐", "ガットセブン"],
  "CRAVITY": ["cravity", "크래비티", "クレビティ"],
  "WEi": ["wei", "위아이", "ウィアイ"],
  "KickFlip": ["kickflip", "kick flip", "킥플립"],
  "E'LAST": ["e'last", "e’last", "엘라스트", "이엘라스트"],
  "NEWBEAT": ["newbeat", "뉴비트"],
  // --- 日本 ---
  ...
  "Hey! Say! JUMP": ["hey! say! jump", "hey say jump", "ヘイセイジャンプ"],
  "Kis-My-Ft2": ["kis-my-ft2", "キスマイ"],
  "A.B.C-Z": ["a.b.c-z", "エービーシーズィー"],
  "WEST.": ["ジャニーズwest", "ジャニーズWEST", "weeeest"],
  "Aぇ! group": ["aぇ! group", "aぇ!group", "aぇグループ"],
  "少年忍者": ["少年忍者"],
  "HiHi Jets": ["hihi jets", "ハイハイジェッツ"],
  "7 MEN 侍": ["7 men 侍", "7men侍"],
  "JO1": ["jo1", "ジェイオーワン"],
  "INI": ["ini", "アイエヌアイ"],
  "ME:I": ["me:i", "ミーアイ"],
  "IS:SUE": ["is:sue", "イッシュ"],
  ...
  "IMP.": ["imp.", "impactors", "アイエムピー"],
  "BE:FIRST": ["be:first", "ビーファースト", "ビーファ"],
  "Da-iCE": ["da-ice", "ダイス"],
  "THE RAMPAGE": ["the rampage", "ランページ"],
  "PSYCHIC FEVER": ["psychic fever", "サイキックフィーバー", "サイフィ"],
  "BALLISTIK BOYZ": ["ballistik boyz", "バリスティックボーイズ", "バリボー"],
  "FANTASTICS": ["fantastics", "ファンタスティックス"],
  "OWV": ["owv", "オウブ"],
  "RUNIDRE": ["runidre", "ルニドレ"],
  "CUTIE STREET": ["cutie street", "キューティーストリート", "キューストリート"],
  "SWEET STEADY": ["sweet steady", "スウィートステディ"],
  "≒JOY": ["≒joy", "ニアジョイ"],
  "WHITE SCORPION": ["white scorpion", "ホワイトスコーピオン", "ホワスコ"],
  "FRUITS ZIPPER": ["fruits zipper", "フルーツジッパー", "フルジ"],
  "CANDY TUNE": ["candy tune", "キャンディーチューン", "キャンチュ"],
  "M!LK": ["m!lk", "ミルク"],
  "私立恵比寿中学": ["私立恵比寿中学", "エビ中"],
  "ばってん少女隊": ["ばってん少女隊", "ばっしょー"],
  "22/7": ["22/7", "ナナニジ"],
  "モーニング娘。": ["モーニング娘", "morning musume", "モー娘"],
  "アンジュルム": ["アンジュルム", "angerme"],
  "Juice=Juice": ["juice=juice", "ジュースジュース"],
  "つばきファクトリー": ["つばきファクトリー"],
  "BEYOOOOONDS": ["beyooooonds", "ビヨーンズ"],
  "OCHA NORMA": ["ocha norma", "オチャノーマ"],
  "ロージークロニクル": ["rosy chronicle", "ロージークロニクル"],
  "超ときめき♡宣伝部": ["超ときめき", "ときめき宣伝部", "とき宣"],
  "Number_i": ["number_i", "number i", "ナンバーアイ"],
  "僕が見たかった青空": ["僕が見たかった青空", "ぼくが見たかった青空", "僕青"],
  "MAZZEL": ["mazzel", "マーゼル"],
  "BUDDiiS": ["buddiis", "バディーズ"],
  "VIBY": ["viby"],
  "GENIC": ["ジェニック"],
  "STARGLOW": ["starglow", "スターグロウ"],
  "ExWHYZ": ["exwhyz", "エクスワイズ"],
